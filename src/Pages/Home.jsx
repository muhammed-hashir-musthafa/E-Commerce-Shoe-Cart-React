...
export default function Home() {
  const { cart, searchFilter, logout, isLoggedIn } = useContext(CartContext);
        ...
        >
          ...
          <div className="relative me-5">
            ...
            <input
              ...
              className="w-full rounded-md border-gray-200 py-1.5 pe-10 shadow-md sm:text-sm ps-2 me-5 "
            />
